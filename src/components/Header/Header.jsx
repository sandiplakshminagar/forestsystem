    ...
    <header className="bg-[#0fa4af] text-white shadow">
      <div className="mx-auto py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between ml-12 mr-10">
        ...
        <div className="flex items-center gap-7">
          <img src={MLLogo} alt="Logo" className="h-15 w-15 object-contain" />
        ...
        {/*  DROPDOWNS */}
        <div className="flex flex-col sm:flex-row gap-3 mt-4 sm:mt-0  p-2 rounded bg-[#0fa4af]">
          {/* District */}
          <select
            ...
            className=" text-black px-3 py-1 rounded mt-4 text-sm  bg-[#e8eff0]
             border border-[#0c96a5] 
             outline-none focus:ring-2 focus:ring-[#057179]"
          >
            <option value="" className="bg-[#eff8f9] text-gray-700 text-sm">
              Select District
            </option>
            {districts.map((d, i) => (
